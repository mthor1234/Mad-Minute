...
//                fragment_madminute_test.setUserInt(numberPicker_1.getValue());
                ...
                fragment_madminute_test.activity = main;

                Intent intent = new Intent(main, fragment_madminute_test.getClass());

                Bundle mBundle = new Bundle();
                mBundle.putStringArrayList("Operators", operators);
                mBundle.putInt("User_Int", numberPicker_1.getValue());
